    ...
    return Scaffold(
      ...
      body:  Center(
        child: SingleChildScrollView(
              child: Container(
                width: Responsive.isDesktop(context)|| Responsive.isTablet(context) ? 600 : MediaQuery.of(context).size.width,
                child: Column(
                ...
                children: <Widget>[
                  ...
                  Obx(() => Container(
                        height:  Responsive.isDesktop(context)|| Responsive.isTablet(context) ? 300 : 150,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  FormVerticalSpace(),
                  PrimaryButton(
                    onPressed: () => productController.createNewProduct(),
                    labelText: 'Upload',
                  ),
                ],),
              )
